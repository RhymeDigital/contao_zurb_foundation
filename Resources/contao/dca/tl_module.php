	...
	'eval'			=> array(
		...
		'columnFields'	=> array(
			...
			(
				...
				'exclude'       	=> true,
				'inputType'     	=> 'select',
				'options_callback'	=> array('\Rhyme\ContaoZurbFoundationBundle\DataContainer\FoundationModule','getAllModules'),
		...
		'eval'			=> array(
				...
				'columnFields'	=> array(
						...
						(
								...
								'exclude'       	=> true,
								'inputType'     	=> 'select',
								'options_callback'	=> array('\Rhyme\ContaoZurbFoundationBundle\DataContainer\FoundationModule','getAllArticles'),
								'eval'              => array('chosen' => true, 'tl_class'=>'zf_module')
						)
				)
		),
