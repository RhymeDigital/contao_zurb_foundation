...
(
		...
		'save_callback' => array('\Rhyme\ContaoZurbFoundationBundle\DataContainer\FoundationContent', 'setTabTitle'),
		'eval'			=> array
		(
				...
				(
						...
						(
								...
								'exclude'       	=> true,
								'inputType'     	=> 'select',
								'options_callback'	=> array('\Rhyme\ContaoZurbFoundationBundle\DataContainer\FoundationContent','getArticles'),
